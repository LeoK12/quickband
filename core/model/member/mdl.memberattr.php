...
class mdl_memberattr extends shopObject {
    ...
    function import_defalutattr(){
            $attrarray = array(
                        array('attr_name'=>__('地区'),'attr_type'=>'area','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'','attr_tyname'=>__('系统默认'),'attr_order'=>'4','attr_group'=>'defalut'),
                        array('attr_name'=>__('联系地址'),'attr_type'=>'addr','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'','attr_tyname'=>__('系统默认'),'attr_order'=>'5','attr_group'=>'defalut'),
                        array('attr_name'=>__('姓名'),'attr_type'=>'name','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'','attr_tyname'=>__('系统默认'),'attr_order'=>'1','attr_group'=>'defalut'),
                        array('attr_name'=>__('手机号码'),'attr_type'=>'mobile','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'number','attr_tyname'=>__('系统默认'),'attr_order'=>'7','attr_group'=>'defalut'),
                        array('attr_name'=>__('固定电话'),'attr_type'=>'tel','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'number','attr_tyname'=>__('系统默认'),'attr_order'=>'8','attr_group'=>'defalut'),
                        array('attr_name'=>__('邮编'),'attr_type'=>'zip','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'number','attr_tyname'=>__('系统默认'),'attr_order'=>'6','attr_group'=>'defalut'),
                        array('attr_name'=>__('性别'),'attr_type'=>'sex','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'','attr_tyname'=>__('系统默认'),'attr_order'=>'2','attr_group'=>'defalut'),
                        array('attr_name'=>__('出生日期'),'attr_type'=>'date','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'','attr_tyname'=>__('系统默认'),'attr_order'=>'3','attr_group'=>'defalut'),
                        array('attr_name'=>__('安全问题'),'attr_type'=>'pw_question','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'','attr_tyname'=>__('系统默认'),'attr_order'=>'9','attr_group'=>'defalut'),
                        array('attr_name'=>__('回答'),'attr_type'=>'pw_answer','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_valtype'=>'','attr_tyname'=>__('系统默认'),'attr_order'=>'10','attr_group'=>'defalut'),
                        ...
                        array('attr_name'=>__('旺旺'),'attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'false','attr_valtype'=>'','attr_tyname'=>__('旺旺'),'attr_order'=>'14','attr_group'=>'contact'),
                        );
